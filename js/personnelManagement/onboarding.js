...
(function(document, window, $) {
    ...
    function queryParams() {
        return {
            employeeId: $(".query_employeeId").val().trim() ?
                $(".query_employeeId").val().trim() : undefined,
            employeeName: $(".query_employeeName").val().trim() ?
                $(".query_employeeName").val().trim() : undefined, //姓名
            ownerId: $(".query_ownerId").val().trim() ?
                $(".query_ownerId").val().trim() : undefined,
            activeStatus: $(".query_activeStatus").val().trim() ?
                $(".query_activeStatus").val().trim() : undefined
        };
    }
    initFn();
    ...
    function queryCompetence() {
        ajax_data(
            "/common/getCompetence", { params: {}, contentType: "application/x-www-form-urlencoded" },
            function(res) {
                console.log(res);
