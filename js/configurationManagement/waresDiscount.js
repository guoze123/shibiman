(function(document, window, $) {
    ...
    $("#waresDiscount").bootstrapTable({
      ...
      columns: [
        ...
        },
        {
          ...
          formatter: function(value, row, index) {
            return `<div style="display:flex;align-items:center">
                        <input class="form-control purchase"  value="${
              row.buyDiscount
        ...
        },
        {
          ...
          formatter: function(value, row,index) {
            return `<div style="display:flex;align-items:center">
                        <input class="form-control ship" value="${
              row.sellDiscount
            }" style="width:150px;margin-right:5px;" data-index="${index}"></div>`;
          }
        }
      ]
    });
  ...
  $("#waresDiscount").on("blur", ".purchase", function(e) {
    let row = $("#waresDiscount").bootstrapTable("getData")[
      $(e.target).attr("data-index")
    ];
    row["buyDiscount"] = $(e.target)
      .val()
      .trim();
  ...
  $(".submitBtn").click(function() {
    ...
    ajax_data(
      ...
      {
        params: { jsonStr: JSON.stringify(allTableData) },
        contentType: "application/x-www-form-urlencoded"
      },
      function(res) {
        console.log(res);
