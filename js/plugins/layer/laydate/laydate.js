...
!(function(a) {
  ...
  (a.laydate = function(b) {
    ...
    (c.scroll = function(a) {
      return (
        (a = a ? "scrollLeft" : "scrollTop"), d.body[a] | d.documentElement[a]
      );
    }),
    ...
    (c.check = function() {
      ...
      if ("" !== d.replace(/\s/g, "")) {
        if (!b.test(d))
          return (
            (c.elem[h.elemv] = ""), c.msg("日期不符合格式，请重新选择。"), 1
          );
        if (f[0])
          return (
            (c.elem[h.elemv] = ""), c.msg("日期不在有效期内，请重新选择。"), 1
          );
    ...
    (c.viewDate = function(a, b, d) {
      ...
      a < (0 | c.mins[0]) && (a = 0 | c.mins[0]),
        ...
        c.each(new Array(3), function(a) {
          c.hmsin[a].value = c.digit(
            c.timeVoid(f.times[a], a) ? 0 | c.mins[a + 3] : 0 | f.times[a]
          );
        }),
    ...
    (c.orien = function(a, b) {
      ...
      (a.style.left = e.left + (b ? 0 : c.scroll(1)) + "px"),
        (d =
          e.bottom + a.offsetHeight / 1.5 <= c.winarea()
            ? e.bottom - 1
          ...
          : ((i = d[e]("div")),
            ...
            (i.innerHTML = j.html =
              ...
              (function() {
                var a = "";
                return (
                  c.each(new Array(12), function(b) {
    ...
    (c.reshow = function() {
      return (
        c.each(c.query("#" + h[0] + " .laydate_show"), function(a, b) {
        ...
        (c.msg = function(a, d) {
          ...
          "string" == typeof a
            ? ((f += "<p>" + a + "</p>"),
              c.shde(b("#" + h[0])),
              c
                .removeClass(e.times, "laydate_time1")
                .addClass(e.times, "laydate_msg"))
            : (e.hmsarr[a]
                ? (f = e.hmsarr[a])
                : ((f += '<div id="laydate_hmsno" class="laydate_hmsno">'),
